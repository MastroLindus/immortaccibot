...
export function dotaApi(baseUrl = "https://api.opendota.com/api"): DotaApi {
    ...
    return {
        getRecentMatches: async (player: string) => getPlayerResponse<ReadonlyArray<RecentMatch>>("recentMatches", player),
...
export type DotaApi = {
    ...
    getPlayerHeroes: (player: string, heroId?: number) => Promise<ReadonlyArray<PlayerHero> | undefined>,
